...
public class ColumnSpecification {
	...
	public ColumnSpecification(PropertyShape pShape, String displayLanguage,String dataLanguage) {
		...
		} else if(pShape.getPath().hasProperty(SHACLM.inversePath)) {
			this.isInverse = true;
			this.propertyUri = pShape.getPath().getProperty(SHACLM.inversePath).getObject().asResource().getURI();
		}
		...
		if(pShape.getPath().equals(SHACLM.or)) {
